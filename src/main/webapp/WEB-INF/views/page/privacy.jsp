...
<body>
	...
	<div class="page-wrap">
		<div class="page-content">
			<div class="title"><span class="title-point">개인정보</span> 처리방침</div>
		</div>
		<div class="text-box">
			<div class="article-title" style="padding-top: 0;">제1조 총칙</div>
			<ol>
			...
			<ol>
				<li>본 사이트는 귀하의 개인정보를 "개인정보의 수집목적 및 이용목적"에서 고지한 범위 내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업·기관에 제공하지 않습니다.</li>
			...
			<ol>
				...
				<li>또는 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.
					<ol>
						<li>개인정보 침해신고센터(한국인터넷진흥원 운영) : (국번없이) 118 (<a href="privacy.kisa.or.kr">privacy.kisa.or.kr</a>)</li>
						<li>개인정보 분쟁조정위원회(국번없이) : 1833-6972 (<a href="www.kopico.go.kr">www.kopico.go.kr</a>)</li>
						<li>대검찰청 사이버범죄수사단 : 02-3480-3573 (<a href="www.spo.go.kr">www.spo.go.kr</a>)</li>
						<li>경찰청 사이버안전국 : (국번없이) 182 (<a href="cyberbureau.police.go.kr">cyberbureau.police.go.kr</a>)</li>
					</ol>
				</li>
			</ol>
