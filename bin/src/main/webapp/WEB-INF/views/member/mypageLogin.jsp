...
<div class="form-signin w-100 m-auto">
  <form id="mypageLogin_form" method="post" >
	...
	<div class="form-text fs-6">
		<span class="text-point">비밀번호를 입력해주세요.</span><br>
		<span class="text-point">회원님의 정보를 안전하게 보호하기 위해 비밀번호를 한번 더 확인합니다.</span>
	</div>	
	</c:if>
    <button class="btn btn-primary w-100 py-2 fs-3" id="mypageLogin_button" type="submit" style="font-size: 22px !important;">로그인</button>
  </form>
</div>
</div>
